 ...
 * <li>else start up a
 * <a href= "http://www.lopakalogic.com/articles/hadoop-articles/hadoop-testing-with-minicluster/"> mini-cluster</a>
 * </li>
 * </ul>
 * </p>
...
public class AutoConfigure {
    ...
    public static org.apache.hadoop.conf.Configuration getConfiguration() throws Exception {
        ...
        for (String resourceName : new String[]{"/hbase.properties", "/hdfs.properties", "/yarn.properties",
